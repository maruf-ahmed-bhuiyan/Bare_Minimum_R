...
I had a problem with understanding the difference between `geom_bar` and `geom_col`. I thought `geom_bar` would give me the result. Here’s the difference between `geom_bar` vs `geom_col`.
